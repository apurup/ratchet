...
export default {
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "/workspace/ratchet/docs-site/sidebars.js",
          "editUrl": "https://github.com/apurup/ratchet/tree/main/docs-site/"
        },
        "blog": false,
        "theme": {
          "customCss": "/workspace/ratchet/docs-site/src/css/custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    ...
    "footer": {
      "style": "dark",
      "copyright": "Copyright © 2026 Ratchet. Built with Docusaurus.",
      "links": []
    },
    "prism": {
      "theme": {
